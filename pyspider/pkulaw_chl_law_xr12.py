...
hidtrsWhere = '377EF8C056C621131891753126C1711A868633FAF7A6E3D9'
...
class Handler(BaseHandler):
    ...
    def detail_page(self, response):
        ...
        # 保存mysql
        if (u'现行有效' in ret['time_valid'] or u'尚未生效' in ret['time_valid']) and (u'部门工作文件' not in ret['force_level'] and
                                                                               u'行政许可批复' not in ret[
                                                                                   'force_level']):
