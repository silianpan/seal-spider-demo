...
# Project: pkulaw_protocol_center 立法资料-中央
...
Db = 'protocol,lawexplanation,whitebook,workreport,introduction'
clust_db = 'protocol'
menu_item = 'lfbj_all'
Search_Mode = 'accurate'
referer = 'http://www.pkulaw.cn/cluster_call_form.aspx?Db=protocol&menu_item=lfbj_all&EncodingName=&keyword=&range=name&'
